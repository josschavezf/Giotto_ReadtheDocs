...
Docker Image
###################
We have set up a `Docker Image <https://hub.docker.com/r/josschavezf/giotto>`__ linked to RStudio with Giotto pre-installed.
...
1. docker pull ``josschavezf/giotto:latest``
2. docker run ``--rm -p 8787:8787 -e PASSWORD=mypassword josschavezf/giotto:latest``
